...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-neutral-950">
      <div className="pointer-events-none absolute -left-32 -top-32 h-72 w-72 rounded-full bg-gradient-to-tr from-emerald-500/30 via-emerald-400/20 to-lime-400/20 blur-3xl" />
      <div className="pointer-events-none absolute -right-24 bottom-0 h-80 w-80 rounded-full bg-gradient-to-tr from-emerald-500/20 via-lime-400/10 to-emerald-400/20 blur-3xl" />
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-16">
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 shadow-[0_8px_40px_rgba(0,0,0,0.35)] backdrop-blur-xl">
          <div className="mb-6 text-center">
            ...
            <h1 className="bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-2xl font-semibold tracking-tight text-transparent">
            ...
            >
              <div className="space-y-2">
                ...
                <Input
                  ...
                  inputMode="numeric"
                  pattern="[0-9]*"
                  className="tracking-[0.4em] border-white/10 bg-white/10 text-center text-lg text-white placeholder:text-neutral-400 focus-visible:ring-white"
                  required
                />
              </div>
              <Button
              ...
              <button
                ...
                className="mx-auto block text-xs text-neutral-400 underline underline-offset-4 hover:text-neutral-300"
              >
